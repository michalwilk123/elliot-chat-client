...
def create_shared_key_X3DH_guest(
    ...
    """Perform a Extended Diffie Hellman handshake
    proposed by the Signal organisation.
    This is the function runned by the party which
    sends an friend invide inside the application.
    Thats why at the end of the name there is
    guest

    :param my_private_id_key: our private id key
    :type my_private_id_key: X25519PrivateKey
    :param my_private_ephemeral_key: our private exclusive key
    :type my_private_ephemeral_key: X25519PrivateKey
    :param estab_public_id_key: second party public id key
    :type estab_public_id_key: X25519PublicKey
    :param estab_public_signed_pre_key: second party public signed pre key
    :type estab_public_signed_pre_key: X25519PublicKey
    :param estab_public_one_time_key: send party public one use key
    :type estab_public_one_time_key: X25519PublicKey
...
def create_shared_key_X3DH_establisher(
    ...
    proposed by the Signal organisation.
    This is the function runned by the party which
    recieves an friend invide inside the application.
    Thats why at the end of the name there is
    establisher

    :param my_private_id_key: our private id key
    :type my_private_id_key: X25519PrivateKey
    :param my_private_signed_pre_key: our private signed pre key
    :type my_private_signed_pre_key: X25519PrivateKey
    :param my_private_one_time_key: our generated one time key
    :type my_private_one_time_key: X25519PrivateKey
    :param guest_public_id_key: public key from the invitator
    :type guest_public_id_key: X25519PublicKey
    :param guest_public_ephemeral_key: exclusive key generated by the invitator
    :type guest_public_ephemeral_key: X25519PublicKey
    :return: shared secret
    :rtype: bytes
    """
