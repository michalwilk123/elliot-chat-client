...
class Establisher:
    def __init__(self, user_state:UserState, /, id_key=None, signed_pre_key=None, DB_PATH:str=DEFAULT_DB_PATH, load_from_db:bool=False):
        """
    ...
    def create_shared_key_X3DH(self, id_key, ephemeral_key) -> None:
        dh1 = self.signed_pre_key.exchange(id_key)
        dh2 = self.id_key.exchange(ephemeral_key)
        dh3 = self.signed_pre_key.exchange(ephemeral_key)
    ...
    def get_public_signed_key(self):
        return self.signed_pre_key.generate()
